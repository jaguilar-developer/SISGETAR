 ...
 */
public class actualizarTarjeta extends javax.swing.JPanel {

    /**
     * Creates new form actualizarTarjeta
     */    
    ...
    private void initComponents() {
        ...
        add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 680, 40));

        jLabel4.setText("MONTO PASAJE:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, -1, -1));
        add(txtMontoPasaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 680, 40));

        jLabel9.setText("DESCRIPCION :");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, -1));
        add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, 687, 40));
        ...
        add(txtServicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 680, 40));
    ...
    public void cargarTarjeta(Tarjeta objTarjeta) {
        txtId.setEnabled(false);
        txtId.setText(String.valueOf(objTarjeta.getIdTarjeta()));
        txtServicio.setText(objTarjeta.getServicio());
        txtMontoPasaje.setText(String.valueOf(objTarjeta.getMontoPasaje()));
        txtDescripcion.setText(objTarjeta.getDescripcion());
    }
    ...
    private void actualizarTarjeta() {        
        ...
        objTarjeta.setIdTarjeta(Integer.valueOf(txtId.getText()));
        ...
        msjRespuesta = tarjetaDatos.actualizarTarjeta(objTarjeta);
